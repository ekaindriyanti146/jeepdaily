...
You may consult this list to find the Privacy Policy for each of the advertising partners of dother.biz.id.

Third-party ad servers or ad networks use technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on dother.biz.id, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.

Note that dother.biz.id has no access to or control over these cookies that are used by third-party advertisers.
...
dother.biz.id does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.
...
---
**Contact Information**
For any questions regarding this policy, please reach out via our [Contact Page](/contact).
